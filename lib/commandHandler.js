...
// New simplified command registration
const registerCommandSimplified = ({ name, desc, accesslevel, isGroupOnly, handler }) => {
    const command = new Command(name, desc, handler, accesslevel, 'General', isGroupOnly);
    commands.set(command.fullCommand, command);
};
...
module.exports = { registerCommand, registerCommandSimplified, executeCommand, commands };
